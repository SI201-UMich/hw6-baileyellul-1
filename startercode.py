...
#I used AI in lines with my AI contract and only asked it to tell me what is wrong but not how to solve it after I attempted to fix the code three times. 
        ...
        try:
            ...
            if isinstance(max_life, int):
                if max_life > best_life:
                    best_life = max_life
                    best_name = name 
                elif max_life == best_life and name < best_name:
                    best_name = name 
        except:
            continue
